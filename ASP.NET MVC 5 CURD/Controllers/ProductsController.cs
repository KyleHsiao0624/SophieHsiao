using ASP.NET_MVC_5_CURD.Models;
using System;
...
namespace ASP.NET_MVC_5_CURD.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductName,Price,Caregory,UnitPrice,UnitRemain")] Products products)
        {
